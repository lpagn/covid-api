...
COPY covid FROM '/Users/luciopagni/eclipse-workspace-2/infovis/update/Covid19Casos.csv' CSV HEADER;

COPY population FROM '/Users/luciopagni/eclipse-workspace-2/infovis/update/population.csv' CSV HEADER;
